      ...
      <div className="App">
        ...
        <div className="main-content">
          <Routes>
            ...
            <Route
              path="/trabajos_de_titulo_pregrado"
              element={<PaginaTrabajoDeTituloPregrado />}
            />
            <Route
              path="/tesis/:id"
              element={<TituloDetalle tipo="pregrado" />}
            />

            <Route
              path="/trabajos_de_titulo_postgrado"
              element={<PaginaTrabajoDeTituloPostgrado />}
            />
            <Route
              path="/tesis/:id"
              element={<TituloDetalle tipo="postgrado" />}
            />
            ...
            <Route
              path="/practicas_iniciales"
              element={<PaginaPracticasIniciales />}
            />
            <Route
              path="/practicas_iniciales/:id"
              element={<PracticaDetalle tipo="inicial" />}
            />
            <Route
              path="/practicas/:id"
              element={<PracticaDetalle tipo="inicial" />}
            ...
            <Route
              path="/practicas_profesionales"
              element={<PaginaPracticasProfesionales />}
            />
            <Route
              path="/practicas_profesionales/:id"
              element={<PracticaDetalle tipo="profesional" />}
            />

            <Route path="/colaboraciones" element={<PaginaColaboraciones />} />
            <Route
              path="/interconexiones"
              element={<PaginaInterconexiones />}
            />
            ...
            <Route
              path="/resultados_busqueda"
              element={<PaginaResultadosBusqueda />}
            />
            ...
            />
            <Route
              path="/admin/nuevo/trabajo-de-titulo"
              element={
                <ProtectedRoute isAuthenticated={isAuthenticated}>
                  <NuevoTrabajoDeTitulo />
                </ProtectedRoute>
              }
            />
            <Route
              path="/admin/nuevo/practica"
              element={
                <ProtectedRoute isAuthenticated={isAuthenticated}>
                  <NuevoPractica />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/admin/editar/colaboracion"
              element={
                <ProtectedRoute isAuthenticated={isAuthenticated}>
                  <EditarColaboracion />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/admin/editar/trabajo-de-titulo"
              element={
                <ProtectedRoute isAuthenticated={isAuthenticated}>
                  <EditarTrabajosDeTitulo />
                </ProtectedRoute>
              }
            />
            <Route
              path="/admin/editar/practica"
              element={
                <ProtectedRoute isAuthenticated={isAuthenticated}>
                  <EditarPractica />
                </ProtectedRoute>
